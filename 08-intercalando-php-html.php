...
<head>
    ...
    <title>Usando PHP intercalado com HTML </title>
</head>
...
?> 
     ...
     <i>(veja que, mudando a lógica e usando variáveis auxiliares, nem precisamos 
        fazer as separações de PHP e HTML)</i>
<?php 
if ($idade >=18){
     $htmlSaida = "<b><?= $aluno ?></b>";
     $palavra = "maior";
